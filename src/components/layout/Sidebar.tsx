...
export function Sidebar({
  ...
  const academicsItems: MenuItem[] = [
    ...
    { id: 'Registration', label: 'Registration', icon: GraduationCapIcon },
    { id: 'Smart E-Learning', label: 'Smart E-Learning', icon: GraduationCapIcon },
    { id: 'Honor List', label: 'Honor List', icon: GraduationCapIcon },
    { id: 'Schedules', label: 'Schedules', icon: CalendarIcon },
    { id: 'Calendars', label: 'Calendars', icon: CalendarRangeIcon },
  ...
  const adminItems: MenuItem[] = isSuperAdmin ? [{ id: 'Manage Advisors', label: 'Manage Advisors', icon: ShieldCheckIcon }] : [];
